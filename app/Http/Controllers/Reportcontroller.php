...
class Reportcontroller extends Controller
{
    public function salesReport(Request $request)
    {
        ...
        $search = $request->input('search'); // search by customer name
        ...
        return view('admin.report.index', compact('orders', 'totalAmount', 'totalOrders', 'start', 'end', 'search'));
    }
    ...
    public function customer()
    {
        ...
        return view('admin.report.customer', compact('reservedCustomers', 'topCustomers'));
    }
