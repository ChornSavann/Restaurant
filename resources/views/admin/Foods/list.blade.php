...
@include('admin.font.index')
    ...
    <div class="app-content-header py-3">
        <div class="container-fluid d-flex justify-content-between align-items-center mb-3">
            <h3 class="mb-0" style="font-family: 'Khmer OS Battambang'; font-weight:bold;">បញ្ជីម្ហូប</h3>
            <a href="{{ route('food.index') }}" class="btn btn-secondary">
                <i class="fa-solid fa-backward"></i> ត្រឡប់ក្រោយ
            </a>
        </div>
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                <h4 class="mb-0">បញ្ជីម្ហូប</h4>
                <span class="text-light small">{{ $foods->total() }} មុខ</span>
            </div>
