    ...
    <div class="app-content-header py-3">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h3 class="mb-0 fw-bold">បញ្ជី Discount Foods</h3>
                        ...
                        <tbody>
                            @forelse($discounts as $index => $discount)
                                <tr>
                                    ...
                                    <td>{{ $discount->food->title ?? '-' }}</td>
                                    <td>{{ number_format($discount->food->price, 2) }} $</td>
                                    <td>{{ $discount->discount_percent }} %</td>
                                    <td>{{ number_format($discount->food->price - ($discount->food->price * $discount->discount_percent) / 100, 2) }}
                                        $</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="9" class="text-center">មិនមាន Discount Foods ទេ</td>
                                </tr>
                            @endforelse
                        </tbody>
                    ...
                    <div class="modal-body p-4">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-8 ps-md-4">
                                <h4 class="fw-bold mb-2">{{ $discount->food->title ?? '-' }}</h4>

                                <p class="mb-1"><strong>តម្លៃដើម:</strong> {{ number_format($discount->food->price, 2) }}
                                    $</p>
                                ...
                                <p class="mb-0"><strong>ប្រភេទ:</strong> {{ $discount->food->category->name ?? '-' }}</p>
                                <p class="mb-0"><strong>ពិពណ៌នា:</strong> {{ $discount->food->desc ?? '-' }}</p>
                            </div>
